        ...
        loggedIn ? (
          <div
            ...
            <div className={appCDStyles.cdBg}>
              ...
              <div className={`${appCDStyles.section} ${appCDStyles.section2}`}></div>
              <div className={`${appCDStyles.section} ${appCDStyles.section3}`}></div>
              <div className={`${appCDStyles.section} ${appCDStyles.section4}`}></div>
            </div>
            <nav 
